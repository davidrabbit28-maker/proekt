...
cheek_left = c.create_oval(70, 180, 120, 230, outline='black', fill='pink', state=HIDDEN)
cheek_right = c.create_oval(280, 180, 330, 230, outline='black', fill='pink', state=HIDDEN)

tongue_main = c.create_rectangle(170, 250, 230, 270, outline="black", fill="red", state=HIDDEN)
